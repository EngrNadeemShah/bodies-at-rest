...
from utils import retrieve_data_file_paths, plot_single_channel
...
if __name__ == '__main__':
	...
	config = {
		...
		'hdf5_file_path':			os.path.join(os.environ['HOME'], 'scratch', 'data', 'pre_processed', 'preprocessed_straight_limbs.hdf5')
	}
	...
	if config['mod'] == 1:
		...
		train_files_dir = os.path.join(os.environ['HOME'], 'coding', 'bodies-at-rest', 'synthetic_data', 'original', 'mod2', 'train', 'straight_limbs')
		valid_files_dir = os.path.join(os.environ['HOME'], 'coding', 'bodies-at-rest', 'synthetic_data', 'original', 'mod2', 'test', 'straight_limbs')
